    ...
    def determine_metadata(self, request, view):
        return setup_response(
            ...
            POST={
                ...
                "output": {"image_url": "http://www.example.com"},
            },
        )


class A1c(BaseMetadata):
    def determine_metadata(self, request, view):
        return setup_response(
            header={"Authorization": "Bearer ${token}"},
            GET={
                    ...
                    "a1cs": [
                        {
                            ...
                            "a1c": 0.0,
                            "recorded_at": "2023-09-21 00:06:14",
                            "created_at": "2023-09-21 00:06:14",
                            "updated_at": "2023-09-21 00:06:14",
                        },
                    ]
                }
            },
            POST={
                "input": {"a1c": 0, "recorded_at": "2023-09-21 00:06:14"},
            },
            DELETE={
                "input": {"ids": [1, 2, 3]},
            },
                    ...
                    "cares": [
                        {
                            ...
                            "reply_id": None,
                            "message": "",
                            "created_at": "2017-11-30 15:46:11",
                            "updated_at": "2017-11-30 15:46:11",
                        },
                    ]
                }
            },

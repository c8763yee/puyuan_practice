    ...
    def determine_metadata(self, request, view):
        return {
            "POST": {
                ...
                "output": clone_output({"token": "Token"}),
            }
        }
...
class SendVerification(BaseMetadata):
    def determine_metadata(self, request, view):
        return {"POST": {"input": {"email": EMAIL}, "output": clone_output()}}
...
class ResetPassword(BaseMetadata):
    def determine_metadata(self, request, view):
        return {
            ...
            "POST": {"input": {"password": "密碼"}, "output": clone_output()},
        }


class CheckRegister(BaseMetadata):
    def determine_metadata(self, request, view):
        return {"GET": {"input": {"email": EMAIL}, "output": clone_output()}}

...
auth_router.register('register/check', AuthView.CheckRegister,
                     basename='check_register')
auth_router.register('auth', AuthView.Login, basename='auth')
# ------------------------------------
verification_router = DefaultRouter()

verification_router.register('send', AuthView.SendVerification,
                             basename='send_verification')
verification_router.register('check', AuthView.CheckVerification,
                             basename='check_verification')

# ------------------------------------
password_router = DefaultRouter()

password_router.register('forgot', AuthView.ForgotPassword,
                         basename='forgot_password')
password_router.register('reset', AuthView.ResetPassword,
